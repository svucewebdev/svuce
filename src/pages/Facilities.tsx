      ...
      <div className="container mx-auto my-6 px-4">
        <div className="mb-8">
          ...
          <div className="relative h-64 md:h-[400px] rounded-lg overflow-hidden mb-8">
            <img
              src="https://lh3.googleusercontent.com/gps-cs-s/AHVAweohCVo1vR0Fdct5qjO75WcT2YZZXOZNG7gNfiYfEERWi9i4l7P1Zc81pDDqjjphS7SMQYW8GWc-iXkqu_Sv6wWIrAo5-3BWrZDeEpl-QOxqzU_eECEmG78S-dZuhBnhMPCc-rSE=s1360-w1360-h1020-rw"
              alt="SVUCE Campus"
